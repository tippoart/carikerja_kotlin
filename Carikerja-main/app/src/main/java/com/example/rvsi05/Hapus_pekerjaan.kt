...
class Hapus_pekerjaan : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hapus_pekerjaan)
        ...
        val query= dbcarikerja.rawQuery("DELETE  from pekerjaan WHERE id='$id_mahasiswa_terpilih'" ,null)
        query.moveToNext()
